...
#count number of HTTP response codes and verbs per IP address
#normalize these features so that identical behavior patterns would be clustered differently 
...
def get_prevectors():
    #list of IPs taken from logs 
    #data_path = "https://github.com/cylance/IntroductionToMachineLearningForSecurityPros/tree/master/clustering_example/data/www.secrepo.com/self.logs"
